        ...
        if(is_post_type_archive( 'tutor_profiles' )){
            ...
            if(isset($_GET['search'])){
                ...
                $meta_query = array(
                    ...
                    array(
                        'key'     => 'education_university_info',
                        'value'   => $_GET['search'],
                        'compare' => 'LIKE'
                    ),
                    array(
                        'key'     => 'education_university_name',
                        'value'   => $_GET['search'],
                        'compare' => 'LIKE'
                    ),
                    array(
                        'key'     => 'tutoring_experience_info',
                        'value'   => $_GET['search'],
                        'compare' => 'LIKE'
                    ),
                    array(
                        'key'     => 'tutoring_experience_role',
                        'value'   => $_GET['search'],
                        'compare' => 'LIKE'
                    ),
                    array(
                        'key'     => 'tutoring_experience_company',
                        'value'   => $_GET['search'],
                        'compare' => 'LIKE'
                    ),
                    array(
                        'key'     => 'written',
                        'value'   => array($_GET['search']),
                        'compare' => 'LIKE'
                    )
                );

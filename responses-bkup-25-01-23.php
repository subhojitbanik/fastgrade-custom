...
class Responses {
    ...
    public function get_action_buttons($atts)
    {
        ...
        if(0 == fg_pd_get_booking_status( ['bidding' => 'yes'] ) && 'accepted' == $bid_status){
            ...
            $booking_link = 'https://fastgrades.net/tutor-dashboard/tutors-tutoring-session-timetable/?request_id='. $request_id .'&responce_id='.$response_id;
            ?>
        ...
        if( 'accepted' != $bid_status ){
            ...
            $edit_link = 'https://fastgrades.net/tutor-dashboard/bids-responses-accepted-denied/edit-bid-response?response_id='.$response_id;
            ?>

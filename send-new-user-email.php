...
add_action('frontend_admin/save_user', 'pd_send_welcome_email', 10, 2);
function pd_send_welcome_email( $form, $user_id ) {
    $user = get_user_by('ID',$user_id);
    //get important fields
    $user_email = $user->user_email;
    $username = $user->user_login;
    $subject = "Welcome to fastgrades!";
    $message = pd_get_welcome_email_html();
...
function pd_get_welcome_email_html(){
    ob_start();
    ?>
        <!doctype html>
                    ...
                    <tr>
                        ...
                        <div class="mj-column-per-100 mj-outlook-group-fix" style="font-size:0px;text-align:left;direction:ltr;display:inline-block;vertical-align:top;width:100%;">
                            ...
                            <tbody>
                                ...
                                <tr>
                                <td align="center" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                                    <div style="font-family:helvetica;font-size:32px;font-weight:700;line-height:1;text-align:center;color:#134478;">Welcome to fastgrades!</div>
                                </td>
                                </tr>
                                <tr>
                                <td align="center" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                                    <div style="font-family:Ubuntu, Helvetica, Arial, sans-serif;font-size:18px;line-height:1;text-align:center;color:#000000;">Thank you for signing up.</div>
                                </td>
                                </tr>
                                <tr>
                                <td align="center" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                                    <div style="font-family:Ubuntu, Helvetica, Arial, sans-serif;font-size:18px;line-height:20px;text-align:center;color:#000000;">We hope our online tutoring platform and services will help you to realize your goals. Whether that is getting help from a tutor or earning money being a tutor. To use our services, please make sure that your profile is complete.</div>
                                </td>
                                </tr>
                                <tr>
                                <td align="center" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                                    <div style="font-family:Ubuntu, Helvetica, Arial, sans-serif;font-size:18px;line-height:20px;text-align:center;color:#000000;">If you are a tutor, please complete the creation and verification of your payment account to get paid and continue to use the system.</div>
                                </td>
                                </tr>
                                <tr>
                                <td align="center" style="font-size:0px;padding:10px 25px;word-break:break-word;">
